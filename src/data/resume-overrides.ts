...
export const resumeOverrides: ResumeSourceOverrides = {
  ...
  experiences: {
    "北京百度网讯科技有限公司-2018-09": {
      summary: "围绕两千万百科词条入库与知识库扩充，负责流程设计、分类策略与天级数据更新链路建设。",
      achievements: [
        "设计从预处理到知识库更新的完整计算链路，明确各阶段输入输出与迭代边界。",
        "结合分类模型、消歧重召回与定义句特征细化，提升词条类别判定与知识节点映射质量。",
        "搭建 Airflow 天级更新流程，并将结果推送到业务方数据库，支撑百科结构化数据能力。",
      ],
      details: {
        refinedTitle: "整理后的详细说明",
        refined: [
          "这段实习经历主要聚焦知识库扩充基础设施建设，目标是把海量百科词条稳定转换成可进入知识库的实体与概念词。",
          "我的工作集中在流程设计、分类与关联策略、以及例行数据生产链路搭建三个部分，更偏向底层能力建设而不是单次离线任务。",
        ],
        originalTitle: "简历原文",
        original: [
  ...
  projects: {
    "baike-knowledge-base": {
      cardMeta: ["百度实习", "知识图谱 / NLP", "主要 RD"],
      cardSummary: "围绕两千万百科词条入库，搭建从页面分类到知识库关联的完整链路，为知识库扩充提供稳定的数据生产能力。",
      cardTags: ["知识图谱", "百科词条分类", "知识关联", "深度学习分类", "Airflow", "数据工程"],
      heroEyebrow: "Featured Project / Internship",
      heroSubtitle: "在百度实习阶段参与知识库扩充基础设施建设，目标是把海量百科词条稳定转成可进入知识库的实体与概念词。",
      showcase: {
        title: "作品展示",
      ...
      storySections: [
        {
          ...
          title: "项目影响",
          items: [
            { value: "98%", label: "整体准确率" },
            { value: "98%+", label: "召回率" },
            { value: "2.6kw+", label: "高质量结果" },
          ],
        },
        {
          kind: "story",
          ...
          sections: [
            ...
            },
            {
              ...
              groups: [
                {
                  title: "项目角色",
                  paragraphs: ["主要RD（项目团队共3人）"],
                },
                {
                  title: "项目时间",
                  paragraphs: ["2018.09 - 2020.07"],
                },
                {
                  title: "项目影响",
                  paragraphs: [
